  ...
  return (
    <div className="sidebar">
        ...
        <div className="sidebar_top">
            ...
            <Avatar 
                src="https://lh3.googleusercontent.com/613ZJsFSLqsKGpht8qxr1FezBeXfUPTWzYVrgq1r8909bugRlvkBPuTTBXs6q8oQ_dWn8j89Zzqu_1bjB1NrV2-wCIgCNexTdwOG4DeS0Sa_OM0=w960-rj-l80-nu-e365"
                className="sidebar_avatar"    
            />
            <h2>Seimon Tamang</h2>
            <h4>seimontamang@gmail.com</h4>
        </div>
